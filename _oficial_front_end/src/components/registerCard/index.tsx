                ...
                {register.isFinished ? (
                    ...
                    <svg className="size-5" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath={`url(#clip_open_${uid})`}>
                            <path d="M9.77778 5.25H10.6667C11.6472 5.25 12.4444 6.03477 12.4444 7V12.25C12.4444 13.2152 11.6472 14 10.6667 14H1.77778C0.795833 14 0 13.2152 0 12.25V7C0 6.03477 0.795833 5.25 1.77778 5.25H8V3.9375C8 1.76285 9.79167 0 12 0C14.2083 0 16 1.76285 16 3.9375V5.25C16 5.73398 15.6028 6.125 15.1111 6.125C14.6194 6.125 14.2222 5.73398 14.2222 5.25V3.9375C14.2222 2.72945 13.2278 1.75 12 1.75C10.7722 1.75 9.77778 2.72945 9.77778 3.9375V5.25Z" fill="#7289DA" />
                        </g>
                        <defs>
